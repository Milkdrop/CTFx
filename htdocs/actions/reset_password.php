...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_POST['action'] == 'reset_password') {
        ...
        $user = db_select_one(
            ...
            array(
                'email' => $_POST[md5(Config::get('SITE_NAME') . 'EMAIL')]
            )
        );
        ...
        if ($user['id']) {
            ...
            $email_body = htmlspecialchars($user['team_name']).', please follow the link below to reset your password:'.
                "\r\n".
                "\r\n".
                Config::get('URL_BASE_PATH') . 'reset_password?action=choose_password&auth_key='.$auth_key.'&id='.$user['id'].
                "\r\n".
                "\r\n".
                'Regards,'.
                "\r\n".
    ...
    // stage 2, part 2
        ...
        $new_password = $_POST[md5(Config::get('SITE_NAME').'PWD')];

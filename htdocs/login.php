...
<input type="email" name="email" style="margin-bottom:8px" placeholder="Email" required autofocus/><br>
<input type="password" name="password" style="margin-bottom:8px" placeholder="Password" required/><br>
<button class="btn-dynamic" type="submit">Login</button>
</form>';

echo section_header("Don't have an account? Register below:");
echo '<div style="width:270px;">' . tag("Your team shares one account", "info.png", true) . '</div>';

echo '<form style="margin-top:8px;" method="post" action="api">
<input type="hidden" name="action" value="register" />
<input type="text" name="team_name" style="margin-bottom:8px" placeholder="Team name" minlength="' 
. Config::get('MIN_TEAM_NAME_LENGTH') . '" maxlength="',Config::get('MAX_TEAM_NAME_LENGTH'),'" required/><br>
<input type="email" name="email" style="margin-bottom:8px" placeholder="Email" required/><br>
<input type="password" name="password" style="margin-bottom:8px" placeholder="Password" required/><br>';
...
echo '<button class="btn-dynamic" type="submit">Register</button>
</form>
</div>

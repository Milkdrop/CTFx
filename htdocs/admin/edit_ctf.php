...
echo section_header('Edit CTF Settings');

section_subhead ("Challenge Start / End Times:");
form_start('/admin/actions/edit_ctf');
form_input_text('CTF Start Time', formatted_date(Config::get('CTF_START_TIME')));
form_input_text('CTF End Time', formatted_date(Config::get('CTF_END_TIME')));

...
function addNavbarMouseoverEffects() {
    ...
    for (var i = 0, len = navbarElements.length; i < len; i++) {
        ...
        if (element.parentNode.classList.contains("active") == false) {
            var chaffle = new Chaffle (element);
            chaffleObjects[element] = chaffle;

            element.addEventListener("mouseenter", function () {
                chaffleObjects[this].init();
...
function addButtonMouseoverEffects() {
    var buttons = [].concat ([].slice.call(document.getElementsByClassName ("btn")), [].slice.call(document.getElementsByClassName ("close")));
    ...
    for (var i = 0, len = buttons.length; i < len; i++) {
        ...
        } else if (buttons[i].classList.contains ("btn-xs")) {
            buttons[i].addEventListener ("mouseenter", function () {
...
function typeWriterSFX () {
    ...
    if (typewriter != undefined) {
        ...
        setTimeout (function () {audio_typewriter.pause ()}, 200 + (1000 / 60) * typewriter.innerText.length);
    }
}
